...
// Rhi.c once per poly sticking out of the implant stack ("not enclosed"), Rhi.e ignored:
// the fixture draws no EXTBlock.
#[case::rhigh("resistor/Rhigh.gds.gz", "TOP",
    vec!["Rhi.a", "Rhi.a", "Rhi.c", "Rhi.c", "Rhi.f", "Rhi.f"], vec!["Rhi.e"])]
...
// (The EXTBlock-less resistor is a resistor and its Rsil.e/Rppd.d "not enclosed" set aside.)
#[case::rsil_d_h1("resistor/Rsil.d.h1.gds.gz", "TOP", vec!["Rsil.d"; 5], vec!["Rsil.c", "Rsil.e", "Rppd.d"])]
...
// (A layer over the body only is one "not enclosed", not one per head: 7.)
#[case::rsil_e_h1("resistor/Rsil.e.h1.gds.gz", "TOP", vec!["Rsil.e"; 7], vec!["Rsil.c"])]
...
// Length and width read the same two dimensions in both tools (finding 6): a 0.495 body
// under a 3.0 RES is Rsil.f too, a 0.495 RES on a 0.6 body Rsil.a too - a second id, no miss.
#[case::rsil_f_h1("resistor/Rsil.f.h1.gds.gz", "TOP", [vec!["Rsil.a"; 6], vec!["Rsil.f"; 6]].concat(), vec![])]
...
// (The body-only pSD is one "not enclosed": 6.)
#[case::rppd_b_h1("resistor/Rppd.b.h1.gds.gz", "TOP", vec!["Rppd.b"; 6], vec![])]
...
// the absent EXTBlock).
#[case::rppd_d_h1("resistor/Rppd.d.h1.gds.gz", "TOP", vec!["Rppd.d"; 7], vec![])]
...
// (The 0.495 bodies are Rppd.a on both walls, the whole block being read now: 6.)
#[case::rppd_e_h1("resistor/Rppd.e.h1.gds.gz", "TOP", [vec!["Rppd.a"; 6], vec!["Rppd.e"; 4]].concat(), vec![])]
...
// The bare nSD:drawing far from any Rhigh stays clean (note 1's letter against the N+ ties
// drawn with nSD everywhere - OPEN); the other four fire.
#[case::rhi_b_h1("resistor/Rhi.b.h1.gds.gz", "TOP", vec!["Rhi.b", "Rhi.b", "Rhi.b", "Rhi.b", "Rhi.c"], vec![])]
...
#[case::rhi_c_h1("resistor/Rhi.c.h1.gds.gz", "TOP", vec!["Rhi.c"; 6], vec![])]
...
#[case::rhi_e_h1("resistor/Rhi.e.h1.gds.gz", "TOP", vec!["Rhi.e"; 7], vec![])]
...
#[case::rhi_f_h1("resistor/Rhi.f.h1.gds.gz", "TOP", [vec!["Rhi.a"; 6], vec!["Rhi.f"; 4]].concat(), vec![])]
